...
module.exports = async ({ req, res, log, error }) => {
    try {
        log('🚀 Family Guard Email OTP Function Started (FIXED VERSION)');
        ...
        const mailOptions = {
            ...
            html: emailHtml,
            text: `Your Family Guard OTP code is: ${otp}. Valid for 5 minutes. Do not share this code. Time: ${new Date().toLocaleString()}`
        };
